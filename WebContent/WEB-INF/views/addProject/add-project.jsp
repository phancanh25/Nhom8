...
<body>
        ...
        <div class="div-add-project">
            <p style="color: #6692e3; font-weight: bold; margin-left: 50px">Giảng viên hướng dẫn ra đề tài <input id="myInput" type="text" placeholder="Tìm kiếm..." style="margin-left: 50px"></p>
