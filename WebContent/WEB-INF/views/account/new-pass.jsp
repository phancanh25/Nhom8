        ...
        <div class="div-new-pass">
            <div class="div-renew-pass" ${token!='expired'?'':'hidden' }>
            	...
            	<form action="set-new-pass.htm" method="POST">
            		...
            		<input type="password" name="newpass1" placeholder="Nhập mật khẩu mới" pattern="^(?=.*[A-Z])(?=.*[!@#$&*])(?=.*[0-9])(?=.*[a-z]).{8,30}$" title="Mật khẩu phải có ít nhất 8 ký tự, tối khiểu 1 ký tự thường, 1 ký tự hoa, 1 ký tự số và 1 ký tự đặc biệt (!,@,#,$,&,*)"  required="required"/>
