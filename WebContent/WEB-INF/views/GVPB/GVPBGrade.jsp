...
<body>
        ...
        <div class="div-mark2">
            <p style="color: #6692e3; font-weight: bold; margin-left: 50px">Giảng viên phản biện chấm điểm <input id="myInput" type="text" placeholder="Tìm kiếm..." style="margin-left: 50px"></p>
