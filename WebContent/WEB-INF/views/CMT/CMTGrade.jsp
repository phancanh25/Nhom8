...
<body>
        ...
        <div class="div-mark3">
            <p style="color: #6692e3; font-weight: bold; margin-left: 50px">Giáo vụ chấm điểm tiểu ban <input id="myInput" type="text" placeholder="Tìm kiếm..." style="margin-left: 50px"></p>
            ...
            <div class="div-mark3-wrapper">
                ...
                <table class="table table-striped table-bordered table-mark3" style="font-size: 13px;">
                    <tr>
                        <th>MSSV</th>
                        <th>Họ</th>
                        <th>Tên</th>
                    ...
                    <tr>
                    	<td>${sinhVien.getMaSV()}</td>
	                        ...
	                        <td><input value="${sinhVien.getDoAn().getTenDA()}" name="tenDA" type="text" placeholder="Tên đồ án" readonly style="opacity: 0.8;" style="opacity: 0.8;" style="opacity: 0.8;"></td>
	                        <td><textarea name="chiTietDA" cols="20" rows="3" placeholder="Chi tiết" readonly style="opacity: 0.8;" style="opacity: 0.8;">${sinhVien.getDoAn().getChiTiet()}</textarea></td>
	                        <td><input name="diemHD" step="0.01" type="number" placeholder="Điểm hd" readonly style="opacity: 0.8;" style="opacity: 0.8;" value="${sinhVien.getDoAn().getDiemHD() }"></td>
	                        ...
	                        <td><input name="diemPB" step="0.01" type="number" placeholder="Điểm pb" readonly style="opacity: 0.8;" style="opacity: 0.8;" value="${sinhVien.getDoAn().getDiemPB() }"></td>
                            <td>
	                            <input type="text" value="${sinhVien.getDoAn().getTieuBan().getTenTB()}" readonly style="opacity: 0.8;"><!-- giaovien.ho.ten -->
	                        </td>
