...
<body>
        ...
        <div class="div-mark1">
            <p style="color: #6692e3; font-weight: bold; margin-left: 50px">Phân công giảng viên hướng dẫn <input id="myInput" type="text" placeholder="Tìm kiếm..." style="margin-left: 50px"></p>
            ...
            <form action="GVHD/gvhd-grade.htm" method="POST">
                <table class="table table-striped table-bordered table-mark1" style="font-size: 13px;">
                    <tr>
                        <th>MSSV</th>
                        <th>Họ</th>
                        <th>Tên</th>
                    ...
                    <c:forEach items="${sinhViens}" var="sinhVien">
	                    <tr>
	                       <td>${sinhVien.getMaSV()}</td>
	                        ...
	                        <td>
	                            <input type="text" value="${sinhVien.getDoAn().getGVHD().getHo()} ${sinhVien.getDoAn().getGVHD().getTen()}" readonly style="opacity: 0.8;" style="opacity: 0.8;"><!-- giaovien.ho.ten -->
	                        </td>
	                        ...
	                        <td><input style="color: blue; font-weight: bold" name="diemHD" step="0.01" value="${sinhVien.getDoAn().getDiemHD()}" type="number" placeholder="Điểm hd" min="0" max="10" title="Từ 0-10, độ chia 0.01" required="required"></td>
